...
// only enable this test where KokkosBlas supports getri:
...
int test_getri() {
  ...
  return 1;
    ...
    (!defined(KOKKOSKERNELS_ETI_ONLY) && \
     !defined(KOKKOSKERNELS_IMPL_CHECK_ETI_CALLS))
TEST_F(TestCategory, getri_float) {
  Kokkos::Profiling::pushRegion("KokkosBlas::Test::getri_float");
  test_getri<float, TestExecSpace>();
  Kokkos::Profiling::popRegion();
    ...
    (!defined(KOKKOSKERNELS_ETI_ONLY) &&  \
     !defined(KOKKOSKERNELS_IMPL_CHECK_ETI_CALLS))
TEST_F(TestCategory, getri_double) {
  Kokkos::Profiling::pushRegion("KokkosBlas::Test::getri_double");
  test_getri<double, TestExecSpace>();
  Kokkos::Profiling::popRegion();
}
    ...
    (!defined(KOKKOSKERNELS_ETI_ONLY) &&          \
     !defined(KOKKOSKERNELS_IMPL_CHECK_ETI_CALLS))
TEST_F(TestCategory, getri_complex_double) {
  Kokkos::Profiling::pushRegion("KokkosBlas::Test::getri_complex_double");
  test_getri<Kokkos::complex<double>, TestExecSpace>();
  Kokkos::Profiling::popRegion();
}
    ...
    (!defined(KOKKOSKERNELS_ETI_ONLY) &&         \
     !defined(KOKKOSKERNELS_IMPL_CHECK_ETI_CALLS))
TEST_F(TestCategory, getri_complex_float) {
  Kokkos::Profiling::pushRegion("KokkosBlas::Test::getri_complex_float");
  test_getri<Kokkos::complex<float>, TestExecSpace>();
  Kokkos::Profiling::popRegion();
}
